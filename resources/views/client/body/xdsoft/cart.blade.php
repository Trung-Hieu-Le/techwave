                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1"
                                            colspan="1" aria-label="Status: activate to sort column ascending"><a
                                                class="fa-solid fa-trash text-danger" href="{{route('delete_all_cart')}}" 
                                ...
                                <tbody style="background-color: white; font-size:18px">
                                    @foreach ($cartItems as $item)
                                        <tr role="row" class="odd" rowId="{{ $item->cart_item_id }}">
                                            <td><img src="{{ $item->img }}" class="card-img-top" style="max-width:180px; max-height:120px" /></td>
                                            <td>{{ $item->name }}</td>
                                            <td>{{ number_format($item->gia_giam) }}đ</td>
                                            <td class="actions">
                                                <a class="btn btn-outline-danger cart-remove"><i class="fa fa-trash-o"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                        ...
                        <div class="cart-total-prices col-xs-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 col-xxl-3">
                            <div class="cart-total-prices_inner">
                                ...
                                <div class="payment" style="background-color: #FCFCFC; padding:10px 20px 0 20px" ;>
                                    <div class="price-item">
                                        ...
                                        <div class="row">
                                            ...
                                            <p class="col-3 col-sm-3 col-md-4 col-lg-4 col-xl-6 m-text-center number-text text-price">
                                                <span style="font-family: Exo,sans-serif !important; color:#3581c4">
                                                    {{number_format($tuition_fee_before_reduction)}}đ</span>
                                                <input id="tieu_de" type="hidden" name="gia_goc" value="{{$tuition_fee_before_reduction}}">
                                    ...
                                    <div class="price-total">
                                        <div class="row">
                                            ...
                                            <p
                                                class="col-3 col-sm-3 col-md-4 col-lg-4 col-xl-6 m-text-center number-text text-price">
                                                <span name="gia_giam" value="{{$total}}" style="font-family: Exo,sans-serif !important; color:#3581c4">
                                                    {{number_format($total)}}đ</span>
                                                    <input id="tieu_de" type="hidden" name="gia_giam" value="{{$total}}">
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-footer d-flex justify-content-center align-items-center">
                                    <button id="normal-payment" type="submit" class="btn btn-primary me-2">Mua hàng</button>
                                    <button id="vnpay-payment" type="button" class="btn btn-success ms-2">Thanh toán VNPay</button>
                                </div>
                            </div>
                        </div>
