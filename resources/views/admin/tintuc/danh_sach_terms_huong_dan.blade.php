        ...
        <div class="card-header">
            <div class="row justify-content-between align-items-center flex-grow-1">
                    ...
                    <form action="{{route('find_term_HD')}}" method="GET">
                        ...
                        <div class="input-group input-group-merge input-group-flush">
                            ...
                            <input id="datatableSearch" type="search" class="form-control"
                                   ...
                                   name="s"
                                   placeholder="Tìm kiếm tag bài viết"
                ...
                <div class="col-sm-6 col-md-4 mb-3 mb-sm-0 d-flex justify-content-end">
                    <a href="{{route('them_term_HD')}}" class="btn btn-primary pt-1 pb-1 pr-2 pl-2">Thêm mới</a>
                </div>
            </div>
            <!-- End Row -->
        </div>
                        ...
                        <tr role="row" class="odd">
                           ...
                           <td>
                            @if(session()->get('role')[0] == 'admin' || session()->get('role')[0] == 'nv')
                                <a class="btn btn-sm btn-white" href="{{route('page_edit_term_HD',['id'=>$ds_terms_huong_dan[$i]->id])}}" >
                                    <i class="tio-edit"></i> Sửa
                                </a>
                            @endif
                            @if(session()->get('role')[0] == 'admin')
                                <a class="btn btn-sm btn-white" href="{{route('delete_term_HD',['id'=>$ds_terms_huong_dan[$i]->id])}}"
