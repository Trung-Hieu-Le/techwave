    ...
    <div class="card" style="max-height: 100vh">
        ...
        <div class="card-header">
            <div class="row justify-content-between align-items-center flex-grow-1">
                <div class="col-sm-6 col-md-4 mb-3 mb-sm-0">
                    <form action="{{route('find_picture')}}" method="GET">
                        <!-- Search -->
                ...
                <div class="col-sm-6 col-md-4 mb-3 mb-sm-0 d-flex justify-content-end">
                    <a href="{{route('them_picture')}}" class="btn btn-primary pt-1 pb-1 pr-2 pl-2">Thêm mới</a>
                </div>
            </div>
            <!-- End Row -->
        </div>
            ...
            <div id="datatable_wrapper" class="dataTables_wrapper no-footer">
                ...
                <table id="datatable"
                    ...
                    <tr role="row">
                        ...
                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                            aria-label="Country: activate to sort column ascending">Tên
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                            aria-label="Country: activate to sort column ascending">Phân loại
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                    ...
                    @foreach ($ds_pictures as $item)
                        <tr role="row" class="odd">
                            ...
                            <td>
                                ...
                                @if(preg_match_all('((http|https)\:\/\/)',$item->picture_image))
                                    <img src="{{ $item->picture_image }}" alt="" style="width: 80px;height: 80px">
                                @else
                                    <img src="{{asset('images/'.$item->picture_image)}}" alt=""
                            ...
                            <td>
                                @if(session()->get('role')[0] == 'admin' || session()->get('role')[0] == 'nv')
                                    <a class="btn btn-sm btn-white"
                                       href="{{route('page_edit_picture',['id'=>$item->id])}}">
        ...
        <div class="card-footer">
            ...
            <div class="row justify-content-center align-items-sm-center">
                {{ $ds_pictures->appends(request()->all())->links()}}
            </div>
            <!-- End Pagination -->
        </div>
        <!-- End Footer -->
