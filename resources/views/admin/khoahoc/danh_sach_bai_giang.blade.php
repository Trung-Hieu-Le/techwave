        ...
        <div class="card-header">
            <div class="row justify-content-between align-items-center flex-grow-1">
                ...
                <div class="col-sm-6 col-md-4 mb-3 mb-sm-0 d-flex justify-content-end">
                    <a href="{{route('them_lesson')}}" class="btn btn-primary pt-1 pb-1 pr-2 pl-2">Thêm mới</a>
                </div>
               {{-- <div class="col-sm-6 col-md-4 mb-3 mb-sm-0">--}}
                    ...
                    @foreach ($ds_lesson as $item)
                        <tr role="row" class="odd">
                            <td>
                                ...
                                ?>
                                <img src="https://i3.ytimg.com/vi/{{ $videoId }}/maxresdefault.jpg" alt="" style="width: 100px; height: 80px; object-fit: cover;">
                            @else
                                <img src="{{asset('image/no_img.jfif')}}" alt="" style="width: 100px; height: 80px; object-fit: cover;">
                            @endif
                            </td>
                            ...
                            <td>
                                ...
                                <a class="btn btn-sm btn-white" href="{{route('page_edit_lesson',['id'=>$item->id])}}">
