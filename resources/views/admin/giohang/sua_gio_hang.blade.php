    ...
    <div class="col-lg-12">
        ...
        <div class="card card-lg mb-3 mb-lg-5">
            ...
            <div class="card-header">
                <h4 class="card-header-title">Sửa giỏ hàng</h4>
            </div>
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <select name="id_user" id="projectNameProjectSettingsLabel"
                                                ...
                                                @foreach($users as $user)
                                                    <option
                                                        value="{{$user->id}}" {{($cart_detail->id_user == $user->id) ? 'selected' : ''}}>{{$user->display_name}}</option>
                                                @endforeach
                            ...
                            <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="trang_thai" name="trang_thai" value="{{$cart_detail->trang_thai}}" class="form-control">
                                        ...
                                        <option value="Đã đặt mua" {{($cart_detail->trang_thai == "Đã đặt mua") ? 'selected' : ''}}>Đã đặt mua</option>
                                        <option value="Đã thanh toán" {{($cart_detail->trang_thai == "Đã thanh toán") ? 'selected' : ''}}>Đã thanh toán</option>
                                        <option value="Lỗi thanh toán" {{($cart_detail->trang_thai == "Lỗi thanh toán") ? 'selected' : ''}}>Lỗi thanh toán</option>
                                        <option value="Hủy đặt mua" {{($cart_detail->trang_thai == "Hủy đặt mua") ? 'selected' : ''}}>Hủy đặt mua</option>
                                        <option value="Đã hoàn tiền" {{($cart_detail->trang_thai == "Đã hoàn tiền") ? 'selected' : ''}}>Đã hoàn tiền</option>
                                        <option value="Lỗi mua hàng" {{($cart_detail->trang_thai == "Lỗi mua hàng") ? 'selected' : ''}}>Lỗi mua hàng</option>
                                    </select>                                    
                                </div>
                                <!-- End Form Group -->
                            </div>
                            <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" name="ghi_chu" id="tieu_de" value="{{$cart_detail->ghi_chu}}"
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <select name="courses[]" id="courses"
                                            ...
                                            <option value="{{$category->id}}" 
                                                ...
                                                {{($item->id_course == $category->id) ? 'selected': ''}}
                                                @endforeach>
                                                {{$category->name}}
                                            </option>
                                            @endforeach
